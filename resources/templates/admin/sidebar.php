        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="$base_url/systemadmin/index.php" class="site_title"><img src="$base_url/assets/images/pcnhslogo.png" style='height: 40px; width: 40px;'/> <span>PCNHS ARMS</span></a>
            </div>
