                 ...
                 <div class="col-sm-5"></div>
                    <div class="col-sm-7">
                        <div class="input-group">
                            <input type="text" class="form-control" name="search_key" placeholder="Search User Activity Logs">
                  ...
                  <div class="pull-right">
                        <a><i class="fa fa-info-circle"></i> Search activity logs by <strong> Username or Activity</strong></a>
                  </div>
                </div>
            </form>
      <div class="row">
