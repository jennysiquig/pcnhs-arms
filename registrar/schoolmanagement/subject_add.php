				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="x_content">
						<form id="subject-val" class="form-horizontal form-label-left" action="phpinsert/subject_insert.php" method="POST" novalidate>
							...
							<div class="item form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">Subject Unit</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input id="name" class="form-control col-md-7 col-xs-12" required="required" type="text" name="unit">
								</div>
							</div>
							<div class="item form-group">
