<?php
	...
	foreach ($_POST['row_number'] as $key => $value) {
		$subj_name = htmlspecialchars(filter_var($_POST['subj_name'][$key], FILTER_SANITIZE_STRING), ENT_QUOTES, 'UTF-8');
		$subj_level = htmlspecialchars(filter_var($_POST['subj_level'][$key], FILTER_SANITIZE_NUMBER_INT), ENT_QUOTES, 'UTF-8');
		$yr_level_needed = htmlspecialchars(filter_var($_POST['yr_level_needed'][$key], FILTER_SANITIZE_NUMBER_INT), ENT_QUOTES, 'UTF-8');
		$subj_order = intval(htmlspecialchars(filter_var($_POST['subj_order'][$key], FILTER_SANITIZE_NUMBER_INT), ENT_QUOTES));
		$credit_earned = intval(htmlspecialchars($_POST['credit_earned'][$key]));

		// echo $subj_name."<br>";
		// echo $subj_level."<br>";
		// echo $yr_level_needed."<br>";
		// echo $subj_order."<br>";
		// echo $credit_earned."<br>";
		// echo $subj_id."<br>";
