<?php
	...
	$updatestmnt1 = "UPDATE `pcnhsdb`.`students` SET `first_name`='$firstName', `mid_name`='$middleName', `last_name`='$lastName', `gender`='$gender', `birth_date`='$birthdate', `birth_place`='$birthplace' WHERE `stud_id`='$stud_id';";
